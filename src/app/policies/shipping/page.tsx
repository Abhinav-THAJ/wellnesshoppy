  ...
  return (
    <div className="pt-28 pb-20 bg-white min-h-screen">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8 font-sans">
        <h1 className="font-heading text-3xl sm:text-5xl font-extrabold text-primary tracking-tight">Shipping Service</h1>
        ...
        <div className="font-body text-xs sm:text-sm text-muted-foreground leading-relaxed font-light space-y-6">
          ...
          <h2 className="font-heading text-lg font-bold text-primary">1. Rates and Delivery Times</h2>
          <p>
          ...
          <h2 className="font-heading text-lg font-bold text-primary">2. Duties and Customs</h2>
          <p>
