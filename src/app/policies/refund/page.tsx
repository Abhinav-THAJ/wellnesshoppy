  ...
  return (
    <div className="pt-28 pb-20 bg-white min-h-screen">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8 font-sans">
        <h1 className="font-heading text-3xl sm:text-5xl font-extrabold text-gray-900 tracking-tight">Refund Guidelines</h1>
        ...
        <div className="font-body text-xs sm:text-sm text-gray-500 leading-relaxed font-light space-y-6">
          ...
          <h2 className="font-heading text-lg font-bold text-gray-900">1. Eligibility</h2>
          <p>
          ...
          <h2 className="font-heading text-lg font-bold text-gray-900">2. Processing Time</h2>
          <p>
