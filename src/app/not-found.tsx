    ...
    <div className="pt-28 pb-20 bg-white min-h-screen flex items-center justify-center text-center">
      <div className="max-w-md w-full px-6 space-y-6">
        ...
        <div className="space-y-2">
          <span className="font-heading text-xs font-bold tracking-[0.25em] text-secondary uppercase">
            Error Code 404
          </span>
        ...
        <div className="pt-4 flex flex-col sm:flex-row gap-3 justify-center">
          <Button asChild className="rounded-full bg-primary text-white hover:bg-primary font-body text-xs uppercase tracking-wider px-8 py-5 h-auto">
            <Link href="/">
              Atelier Home
            </Link>
          </Button>
